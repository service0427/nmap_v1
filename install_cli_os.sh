...
sudo apt update
sudo apt install -y git screen adb curl wget build-essential cron net-tools nano ffmpeg jq bc openssl libssl-dev zlib1g-dev libffi-dev tcpdump iputils-ping dnsutils

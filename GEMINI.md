...
*   **Wi-Fi Scheduler**: `mode_wifi/run_scheduler.sh`는 [pm2_setup.sh](file:///home/tech/nmap_mini/pm2_setup.sh)를 통해 `wifi-scheduler`라는 이름으로 PM2에 등록되며, 스케줄러 중복 방지를 위해 기본적으로 **중지(STOPPED)** 상태로 저장됩니다.
